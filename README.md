...
> <!--qe:skills-->183<!--/qe:skills--> skills | <!--qe:agents-->27<!--/qe:agents--> agents | Folder-aware context memory | SIVS quality gate
...
That's it. All <!--qe:skills-->183<!--/qe:skills--> skills, <!--qe:agents-->27<!--/qe:agents--> agents, and hooks are active immediately.
