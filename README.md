...
> <!--qe:skills-->41<!--/qe:skills--> skills | <!--qe:agents-->27<!--/qe:agents--> agents | Folder-aware context memory | SIVS quality gate
...
## Skill Library (<!--qe:skills-->41<!--/qe:skills--> skills)
...
| **Project** | `Qcommit` `Qarchive` `Qproject-sync` | 3 |
