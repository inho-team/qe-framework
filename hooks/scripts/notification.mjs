...
import { readFileSync, existsSync, unlinkSync } from './lib/qe-fs.mjs';
...
const chains = [
  ...
  { match: 'Edoc-writer',        hint: 'Documentation generated by Edoc-writer. Review output or generated file paths with user.' },
