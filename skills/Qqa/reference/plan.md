# Qqa plan — QA Test Planner

Behavior preserved from `Qqa-test-planner`.

Generates test plans, manual test cases, regression suites, Figma design verifications, and bug
reports.

> Activation: `Qqa plan [target]` or direct invocation of `Qqa-test-planner`.
...
- [ ] Scope clearly defined, including in-scope and out-of-scope areas
