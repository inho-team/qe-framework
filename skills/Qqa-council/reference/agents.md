...
- **Probes:** invalid/oversized/empty input, boundary values, auth/permission edges, responsive
  breakpoints (mobile/tablet/desktop), broken-flow recovery, and requested guardrail scenarios.
