...
- 사용자에게 안내하지 않습니다.
- 완료된 TASK_REQUEST와 VERIFY_CHECKLIST를 `.claude/.archive/vX.Y.Z/`로 이동합니다.
...
|------|--------|--------|-------------|-----------|
| 생성 | `/Qgenerate-spec` | `tasks/pending/` | `checklists/pending/` | 🔲 |
| 시작 | `/Qrun-task` 승인 후 | `tasks/in-progress/` | `checklists/in-progress/` | 🔶 |
