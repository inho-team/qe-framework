...
## 가정 (AI 결정)
<!-- 선택 사항 — 사용자가 "나머지는 알아서"로 위임한 결정만 기록. 위임이 없으면 섹션 생략. 실행 전 검토·수정 대상 -->
...
## How to Run
- Standard: `/Qexecute {{UUID}}`
- **Atomic Wave (High Speed)**: `/Qexecute {{UUID}}` (Best if steps are simple and independent)
