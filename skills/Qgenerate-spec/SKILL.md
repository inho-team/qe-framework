...
복잡한 프로젝트이거나 PRD 수준의 기획이 필요한 경우, `Epm-planner` 에이전트에 위임하여 상세한 요구사항 분석을 수행할 수 있습니다.

기술 스택 선정이나 아키텍처 결정이 필요한 경우, `Edeep-researcher` 에이전트에 위임하여 기술 조사 및 비교 분석을 수행할 수 있습니다.
