...
### Claude Code를 위한 스펙 기반 작업 실행 프레임워크

[![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&weight=500&size=22&pause=1000&color=60A5FA&center=true&vCenter=true&width=500&lines=%EC%8A%A4%ED%8E%99+%EC%97%86%EB%8A%94+%EC%9E%91%EC%97%85%EC%9D%80+%EC%B6%94%EC%B8%A1%EC%9D%B4%EB%8B%A4.;%EA%B2%80%EC%A6%9D+%EC%97%86%EB%8A%94+%EC%8A%A4%ED%8E%99%EC%9D%80+%ED%9D%AC%EB%A7%9D%EC%9D%B4%EB%8B%A4.;%EA%B0%90%EB%A6%AC+%EC%97%86%EB%8A%94+%EA%B2%80%EC%A6%9D%EC%9D%80+%ED%99%95%EC%A6%9D+%ED%8E%B8%ED%96%A5%EC%9D%B4%EB%8B%A4.)](https://github.com/inho-team/qe-framework)
...
**개요:** [철학](#철학) · [아키텍처](#아키텍처) · [작동 방식](#background-processing)

**시작하기:** [설치](#설치) · [초기화](#프로젝트-초기화) · [사용법](#사용법)

**레퍼런스:** [스킬](#skills-68--72-coding-experts) · [코딩 전문가](#coding-expert-skills-72) · [에이전트](#agents-21) · [훅](#lifecycle-hooks)
...
| `UserPromptSubmit` | 사용자 메시지 전송 | Haiku 번역 기반 **i18n 인텐트 자동 분류** + **언어 감지** (`.qe/profile/language.md`에 저장) |
...
├── agents/            # 21개 에이전트 (E-prefix)
├── skills/            # 68개 core + 72개 coding expert 스킬 (Q-prefix)
├── core/              # 공유 원칙 및 설정
├── hooks/             # 9개 라이프사이클 훅 + i18n 번역 레이어
├── install.js         # 설치 스크립트
└── package.json
```
